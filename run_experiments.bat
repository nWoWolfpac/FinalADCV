@echo off
REM Script to run multiple UNet++ experiments with different configurations (Windows)
...
REM Experiment 1: ResNet50 baseline (no deep supervision)
...
REM Experiment 2: ResNet50 with deep supervision
...
REM Experiment 3: MobileViT with deep supervision
...
REM Experiment 4: ResNet101 with deep supervision (best accuracy)
